  ...
  useEffect(() => {
    if (popular.strict) {
      ...
      popular.getSeriesUrl(
        `https://api.themoviedb.org/3/tv/top_rated?api_key=fd8d6c89de4982d8d30b319843006081&language=en-US&page=${popular.page}`
      );
      popular.strict = true;
    }
  }, [popular]);
